...
public class Employee extends Person implements Worker{
    ...
    public Employee(int num, String name, int age, Status status) {
    ...
    public String toString() {
        return
        "[ Employee ] EmployNumber: " + this.employNum +
        ", NAME: " + this.name +
        ", AGE: " + this.age +
        ", STATUS: " + this.status.lable;
    }

    public int getNum() { return this.employNum; }
	public String getName() { return this.name; }
    public int getAge() { return this.age; }
    public String getStatus() { return this.status.lable; }

    public void setNum(int num) { this.employNum = num; }
